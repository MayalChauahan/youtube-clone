    ...
    return (
        <div className="flex justify-center flex-row h-[calc(100%-56px)] mt-16">
            <div className="w-full max-w-[1580px] flex flex-col lg:flex-row">
                <div className="flex flex-col lg:w-[calc(100%-200px)] xl:w-[calc(100%-300px)] px-4 py-3 lg:py-6">
                    ...
                    <div className="flex justify-between flex-col md:flex-row mt-4">
                        <div className="flex ">
                            ...
                            <div className="flex space-x-5">
                                ...
                                <span className="mt-1 text-center bg-slate-950 px-3 py-2 rounded-full text-white cursor-pointer hover:bg-slate-800 duration-200 ">
                                    Subscribe
                                </span>
                            </div>
                        </div>
                ...
                <div>
                    {relatedVideo?.contents?.map((items, index) => {
                        if (items?.type !== 'video') return false;
                        return <SuggestedVideo key={index} video={items?.video} />
                    })}
                </div>
            </div>
        </div>
